...
new TypeIt("#teks1", {
  strings: [
    "Selamat ulang tahun, Talitha.",
    "Hari ini aku cuma mau kamu tahu… aku ikut bahagia karena kamu masih ada dan bertahan sejauh ini.",
    "Semoga semua lelahmu diganti dengan hal-hal yang lebih indah.",
    "Semoga kamu selalu dikelilingi orang-orang yang tulus menjaga kamu.",
    "Dan semoga, pelan-pelan, semua yang kamu impikan menemukan jalannya."
  ],
  startDelay: 4000,
  speed: 75,
...
// Penutup dengan vibes HTS
new TypeIt("#teks2", {
  strings: [
    "Aku mungkin bukan siapa-siapa dengan status yang jelas di hidupmu.",
    "Tapi doaku selalu punya tempat khusus untuk kamu.",
    "Terima kasih sudah jadi bagian kecil yang berarti di hariku.",
